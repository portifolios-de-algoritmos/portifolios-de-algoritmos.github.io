...
PORTFOLIOS = [
    ...
    },
    {
        ...
        "status": "online",
        "sugestoes": [
            "Transformar o site num portfólio de verdade: a página publicada ainda é um tutorial genérico de Python, falta a seção \"Atividades\" com cada exercício e projeto entregues, com data e tema.",
            "Publicar o código das próprias soluções (.py) no repositório e exibi-lo com realce de sintaxe, no lugar dos exemplos genéricos. Criar a pasta entregas/, pois os links de código previstos hoje levariam a 404.",
            ...
            "Consolidar o trabalho num único repositório/site e apontar o link do mural para essa versão, evitando a dispersão atual em vários repositórios.",
        ],
    },
    {
        "slug": "diogo",
    ...
    },
    {
        ...
        "iniciais": "KS",
        "curso": "",
        "intro": "Acervo publicado com cerca de 35 entregas da disciplina, carregadas dinamicamente.",
        "tech": ["Python", "JavaScript", "HTML", "CSS"],
        "url": "https://kauasantosaluno-tech.github.io",
        "status": "online",
        "sugestoes": [
            "Corrigir o encoding (UTF-8) dos títulos com mojibake (ex.: \"KauÃ£ Lopes\", \"programaÃ§Ã£o\").",
            "Preencher a descrição de cada publicação com um enunciado curto explicando a atividade (hoje o campo está vazio).",
            "Corrigir erros de ortografia nos títulos (\"análise\" no lugar de \"analize\", \"algoritmo\" no lugar de \"algoritimo\").",
            "Remover as pastas de teste (teste, zulu) em uploads/ e organizar a galeria por atividade, já que há várias partes numeradas.",
        ],
    },
    {
